...
- 전반기에는 다변량 데이터 분석, 후반기에는 시계열 데이터 분석과 신경망에 대해 강의

- 통계학 이론에 기반한 회귀분석의 관점에서 다변량 데이터 분석에 어떤 측면에서 한계가 있는지를 확인
...
- 매주 수업자료와 코드자료를 [깃허브](https://github.com/esoterikosQ/2026DataAlgorithm.git)를 통해 배포할 예정

- 매주 주차별 수업자료를 읽고, 코드자료에 주석을 달아 과제로 제출하는 과제 수행
    
    - 수업 시작 전까지 이메일(seunggyu.bak@gmail.com)로 제출

- 중간과제는 9주차(군집분석 수업 이후), 기말과제는 16주차(학기 종료 전)까지 제출하는 것을 원칙으로 하되, 가급적 주차별 과제를 수행하면서 마감기한 이전에 언제든지 제출할 것을 권장
...
### 2.4. 다음 분석 방법 중 직접 수행해봤거나 코딩해본 경험이 있는 방법에 대해 설명
...
- 특별한 사정이 없는 한 강의일로부터 최소 3일 이전까지 다음 차시 강의자료를 업로드할 예정
...
- 생성형AI를 이용한 학습과 코딩을 적극 권장. 과제 역시 생성형AI를 적극 활용하여 수행할 것을 권장하며, 생성형을 어떻게 이용했는지에 대한 주석을 반드시 붙일 것
